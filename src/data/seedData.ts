...
export const INITIAL_ARTICLES: Article[] = [
  ...
  {
    id: 'art-chanh-hiep-05',
    title: 'Ủy ban MTTQ phường Chánh Hiệp bàn giao “Nhà Đại đoàn kết” cho hộ cận nghèo tại Khu phố 8',
    slug: 'ban-giao-nha-dai-doan-ket-cho-ho-can-ngheo-tai-khu-pho-8',
    category: 'An sinh xã hội',
    summary: 'Sáng ngày 02/9/2026, UBMTTQ Việt Nam phường Chánh Hiệp cùng các nhà hảo tâm tổ chức lễ bàn giao căn nhà Đại đoàn kết cho gia đình có hoàn cảnh khó khăn tại Khu phố 8 với tổng kinh phí hỗ trợ 80 triệu đồng.',
    content: 'Tại buổi lễ trao nhà, đại diện Thường trực Đảng ủy và Ban Thường trực UBMTTQ Việt Nam phường Chánh Hiệp đã trao quyết định bàn giao nhà, tặng quà và đồ dùng sinh hoạt thiết yếu, động viên gia đình vươn lên ổn định cuộc sống.',
    featuredImage: 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?auto=format&fit=crop&w=800&q=80',
    tags: ['Nhà Đại đoàn kết', 'Quỹ Vì người nghèo', 'Khu phố 8'],
    authorName: 'Ban Vận động Quỹ Vì người nghèo',
  ...
  {
    id: 'art-chanh-hiep-06',
    title: 'Phường Chánh Hiệp đẩy mạnh chuyển đổi số: Hướng dẫn công dân nộp hồ sơ trực tuyến và sử dụng VNeID',
    slug: 'phuong-chanh-hiep-day-manh-chuyen-doi-so-vneid-dich-vu-cong',
    category: 'Chuyển đổi số',
    summary: 'Tổ Công nghệ số cộng đồng tại 21 khu phố phường Chánh Hiệp tích cực "đi từng ngõ, gõ từng nhà" hỗ trợ người dân kích hoạt tài khoản định danh điện tử VNeID mức 2 và thực hiện dịch vụ công trực tuyến.',
    content: 'Đến nay, tỷ lệ hồ sơ thủ tục hành chính được tiếp nhận và xử lý trực tuyến toàn trình tại Bộ phận Một cửa phường Chánh Hiệp đạt trên 98.5%, góp phần tiết kiệm thời gian, chi phí cho tổ chức và nhân dân.',
    featuredImage: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=800&q=80',
    tags: ['Chuyển đổi số', 'VNeID', 'Dịch vụ công trực tuyến'],
    authorName: 'Tổ Chuyển đổi số',
  ...
  {
    id: 'art-chanh-hiep-07',
    title: 'Ra quân “Ngày Chủ nhật xanh” xóa điểm đen rác thải, chỉnh trang 15 tuyến hẻm văn minh',
    slug: 'ra-quan-ngay-chu-nhat-xanh-xoa-diem-den-rac-thai-chinh-trang-tuyen-hem',
    category: 'Tuyên truyền',
    summary: 'Hơn 300 cán bộ, đoàn viên, hội viên và nhân dân phường Chánh Hiệp đồng loạt ra quân dọn dẹp vệ sinh môi trường, thu gom hơn 4 tấn rác thải và trồng mới 120 cây xanh trên các tuyến đường chính.',
    content: 'Hoạt động nhằm nâng cao ý thức giữ gìn vệ sinh môi trường, tạo cảnh quan đô thị sáng - xanh - sạch - đẹp, hướng đến chào mừng các ngày lễ lớn của quê hương, đất nước.',
    featuredImage: 'https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?auto=format&fit=crop&w=800&q=80',
    tags: ['Ngày Chủ nhật xanh', 'Môi trường', 'Khu dân cư tự quản'],
    authorName: 'Đoàn Thanh niên & Hội Phụ nữ',
  ...
  {
    id: 'art-chanh-hiep-08',
    title: 'Hội nghị tiếp xúc, đối thoại trực tiếp giữa người đứng đầu Cấp ủy, Chính quyền với nhân dân phường Chánh Hiệp',
    slug: 'hoi-nghi-tiep-xuc-doi-thoai-truc-tiep-giua-nguoi-dung-dau-voi-nhan-dan',
    category: 'Hoạt động Mặt trận',
    summary: 'Hội nghị ghi nhận 18 lượt ý kiến tâm huyết của cử tri và nhân dân đóng góp cho công tác quy hoạch, chỉnh trang đô thị, an ninh trật tự và giải quyết chế độ chính sách an sinh xã hội.',
    content: 'Các ý kiến, kiến nghị chính đáng của bà con nhân dân đã được Thường trực Đảng ủy, lãnh đạo UBND và các ban ngành phường Chánh Hiệp trực tiếp giải trình, tiếp thu và chỉ đạo xử lý dứt điểm.',
    featuredImage: 'https://images.unsplash.com/photo-1517048676732-d65bc937f952?auto=format&fit=crop&w=800&q=80',
    tags: ['Đối thoại nhân dân', 'Ý kiến cử tri', 'Dân chủ cơ sở'],
    authorName: 'Văn phòng Đảng ủy - MTTQ',
  ...
  {
    id: 'art-chanh-hiep-09',
    title: 'Trạm Y tế phường Chánh Hiệp tổ chức khám sức khỏe và phát thuốc miễn phí cho hơn 150 người cao tuổi',
    slug: 'tram-y-te-phuong-chanh-hiep-kham-suc-khoe-mien-phi-nguoi-cao-tuoi',
    category: 'An sinh xã hội',
    summary: 'Chương trình khám sức khỏe định kỳ kết hợp tầm soát bệnh mãn tính không lây, đo huyết áp, siêu âm tổng quát và tư vấn dinh dưỡng cho các cụ cao tuổi, gia đình chính sách trên địa bàn phường.',
    content: 'Đây là hoạt động thường niên mang ý nghĩa nhân văn sâu sắc, thể hiện sự quan tâm của cấp ủy, chính quyền và các đoàn thể phường Chánh Hiệp đối với công tác chăm sóc sức khỏe ban đầu cho người dân.',
    featuredImage: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&w=800&q=80',
    tags: ['Khám bệnh miễn phí', 'Người cao tuổi', 'Trạm Y tế Chánh Hiệp'],
    authorName: 'Hội Người cao tuổi & Trạm Y tế',
...
export const INITIAL_DOCUMENTS: OfficialDocument[] = [
  {
    id: 'doc-mttq-01',
    codeNumber: '18/KH-MTTQ-BTT',
    title: 'Kế hoạch Triển khai chương trình công tác Mặt trận Tổ quốc Việt Nam phường Chánh Hiệp năm 2026',
    docType: 'Kế hoạch',
    issuer: 'Ủy ban MTTQ Việt Nam phường Chánh Hiệp',
    issueDate: '2026-01-15',
    effectiveDate: '2026-01-15',
    signer: 'Trần Thị Hoa',
    signerPosition: 'Chủ tịch Ủy ban MTTQ Việt Nam phường',
    field: 'Tổ chức - Tuyên giáo',
    direction: 'OUTGOING',
    urgency: 'NORMAL',
    status: 'ISSUED',
    effectiveStatus: 'EFFECTIVE',
    recipientOrg: 'Đảng ủy, UBND phường, Các tổ chức thành viên & 21 Ban Công tác Mặt trận Khu phố',
    isPublic: true,
    isDigitalSigned: true,
    signedAt: '2026-01-15 08:30:00',
    summary: 'Kế hoạch tổng thể xác định 05 chương trình phối hợp thống nhất hành động năm 2026 của UBMTTQ Việt Nam phường Chánh Hiệp: Nâng cao hiệu quả tuyên truyền, vận động, tập hợp các tầng lớp nhân dân; Đẩy mạnh các phong trào thi đua yêu nước; Thực hiện dân chủ, giám sát và phản biện xã hội; Tăng cường đoàn kết quốc tế; Đổi mới nội dung và phương thức hoạt động.',
    fileName: '18_KH_MTTQ_BTT_Ke_hoach_cong_tac_Mat_tran_2026.pdf',
    fileSize: '1.45 MB',
    ...
    tags: ['Kế hoạch năm 2026', 'Công tác Mặt trận', 'Đại đoàn kết', '21 Khu phố'],
    viewCount: 418,
    downloadCount: 124,
    aiSummary: 'Kế hoạch số 18/KH-MTTQ-BTT tập trung vào 5 nhóm nhiệm vụ trọng tâm năm 2026, nhấn mạnh việc vận động xây dựng đô thị văn minh, giảm nghèo bền vững và giám sát đầu tư cộng đồng tại 21 khu phố.',
    aiActionPoints: [
      'Tổ chức quán triệt Kế hoạch đến 21 Ban Công tác Mặt trận trước ngày 28/02/2026.',
      'Phát động phong trào thi đua "Toàn dân đoàn kết xây dựng đô thị văn minh" gắn với công tác chuyển đổi số.',
      'Duy trì hiệu quả các mô hình tự quản tại khu dân cư.'
    ]
  },
  {
    id: 'doc-mttq-02',
    codeNumber: '24/KH-MTTQ-BTT',
    title: 'Kế hoạch Tổ chức Ngày hội Đại đoàn kết toàn dân tộc ở 21 Khu phố nhân kỷ niệm 96 năm Ngày truyền thống Mặt trận Tổ quốc Việt Nam (18/11/1930 - 18/11/2026)',
    docType: 'Kế hoạch',
    issuer: 'Ủy ban MTTQ Việt Nam phường Chánh Hiệp',
    ...
    signer: 'Trần Thị Hoa',
    signerPosition: 'Chủ tịch Ủy ban MTTQ Việt Nam phường',
    field: 'Phong trào - Thi đua',
    direction: 'OUTGOING',
    urgency: 'URGENT',
    status: 'ISSUED',
    effectiveStatus: 'EFFECTIVE',
    recipientOrg: 'Ban Thường vụ Đảng ủy, UBND phường, 21 Ban Điều hành & Ban Công tác Mặt trận Khu phố',
    isPublic: true,
    isDigitalSigned: true,
    signedAt: '2026-08-25 14:15:00',
    summary: 'Kế hoạch hướng dẫn tổ chức phần Lễ và phần Hội trong Ngày hội Đại đoàn kết toàn dân tộc năm 2026 tại 21 Khu phố; biểu dương các gia đình văn hóa tiêu biểu, gương người tốt việc tốt và phát động đợt cao điểm vì người nghèo.',
    fileName: '24_KH_MTTQ_To_chuc_Ngay_hoi_Dai_doan_ket_2026.pdf',
    fileSize: '980 KB',
    fileType: 'application/pdf',
    fileUrl: 'https://drive.google.com/file/d/1jz3QltvYgaHqG9uZUiJtBtowU4OM7G3G/view?usp=sharing',
    driveUrl: 'https://drive.google.com/file/d/1jz3QltvYgaHqG9uZUiJtBtowU4OM7G3G/view?usp=sharing',
    tags: ['Ngày hội Đại đoàn kết', '18/11/2026', '21 Khu phố', 'Gia đình văn hóa'],
    viewCount: 312,
    downloadCount: 89
  },
  {
    id: 'doc-mttq-03',
    codeNumber: '08/QĐ-MTTQ-BTT',
    title: 'Quyết định Về việc Kiện toàn Ban Thanh tra nhân dân và Ban Giám sát đầu tư của cộng đồng phường Chánh Hiệp nhiệm kỳ 2024 - 2029',
    docType: 'Quyết định',
    issuer: 'Ủy ban MTTQ Việt Nam phường Chánh Hiệp',
    ...
    signer: 'Trần Thị Hoa',
    signerPosition: 'Chủ tịch Ủy ban MTTQ Việt Nam phường',
    field: 'Dân chủ - Pháp luật',
    direction: 'OUTGOING',
    urgency: 'NORMAL',
    status: 'ISSUED',
    effectiveStatus: 'EFFECTIVE',
    recipientOrg: 'Thường trực HĐND, UBND phường, Ban TTND, Ban GSĐTCCĐ & Lưu VP',
    isPublic: true,
    isDigitalSigned: true,
    summary: 'Kiện toàn danh sách thành viên Ban Thanh tra nhân dân gồm 11 đồng chí và Ban Giám sát đầu tư cộng đồng phường Chánh Hiệp nhằm nâng cao hiệu quả giám sát các công trình dân sinh và tiếp công dân.',
    fileName: '08_QD_MTTQ_Kien_toan_Ban_TTND_GScongdong.pdf',
    fileSize: '820 KB',
    fileType: 'application/pdf',
    tags: ['Ban Thanh tra nhân dân', 'Giám sát cộng đồng', 'Quyết định kiện toàn'],
    viewCount: 195,
    downloadCount: 45
  },
  {
    id: 'doc-mttq-04',
    codeNumber: '42/CV-MTTQ-BTT',
    title: 'Công văn Vận động ủng hộ Quỹ "Vì người nghèo" và thực hiện các chương trình an sinh xã hội chăm lo cho đối tượng yếu thế năm 2026',
    docType: 'Công văn',
    issuer: 'Ủy ban MTTQ Việt Nam phường Chánh Hiệp',
    issueDate: '2026-03-05',
    effectiveDate: '2026-03-05',
    signer: 'Nguyễn Văn Hải',
    signerPosition: 'Phó Chủ tịch Ủy ban MTTQ Việt Nam phường',
    field: 'An sinh xã hội',
    direction: 'OUTGOING',
    urgency: 'URGENT',
    status: 'ISSUED',
    effectiveStatus: 'EFFECTIVE',
    recipientOrg: 'Các cơ quan, đơn vị, doanh nghiệp, nhà hảo tâm và nhân dân trên địa bàn phường',
    isPublic: true,
    isDigitalSigned: true,
    summary: 'Kêu gọi các cơ quan, tổ chức, doanh nghiệp, mạnh thường quân và các tầng lớp nhân dân phát huy tinh thần tương thân tương ái, đóng góp ủng hộ Quỹ Vì người nghèo để xây sửa nhà đại đoàn kết, hỗ trợ sinh kế và học bổng khuyến học.',
    fileName: '42_CV_MTTQ_Van_dong_Quy_Vi_nguoi_ngheo_2026.pdf',
    fileSize: '650 KB',
    fileType: 'application/pdf',
    tags: ['Quỹ Vì người nghèo', 'An sinh xã hội', 'Nhà đại đoàn kết'],
    viewCount: 520,
    downloadCount: 160
  },
  {
    id: 'doc-mttq-05',
    codeNumber: '05/HD-MTTQ-BTT',
    title: 'Hướng dẫn Quy trình tổ chức Hội nghị tiếp xúc cử tri và đối thoại trực tiếp giữa người đứng đầu cấp ủy, chính quyền với nhân dân phường Chánh Hiệp',
    docType: 'Hướng dẫn',
    issuer: 'Ủy ban MTTQ Việt Nam phường Chánh Hiệp',
    ...
    status: 'ISSUED',
    effectiveStatus: 'EFFECTIVE',
    recipientOrg: 'Thường trực Đảng ủy, HĐND, UBND, 21 Ban Công tác Mặt trận Khu phố',
    isPublic: true,
    isDigitalSigned: true,
    summary: 'Hướng dẫn chi tiết quy trình chuẩn bị, điều hành và tổng hợp ý kiến cử tri tại các buổi tiếp xúc của Đại biểu Quốc hội, HĐND các cấp và các hội nghị đối thoại nhân dân theo Quyết định 218-QĐ/TW.',
    fileName: '05_HD_MTTQ_Tiep_xuc_cu_tri_Doi_thoai_nhan_dan.pdf',
    fileSize: '1.12 MB',
    fileType: 'application/pdf',
    tags: ['Tiếp xúc cử tri', 'Đối thoại nhân dân', 'Dân chủ cơ sở'],
    viewCount: 260,
    downloadCount: 78
  },
  {
    id: 'doc-mttq-06',
    codeNumber: '118/UBND-VP',
    title: 'Công văn Về việc Phối hợp tuyên truyền, vận động nhân dân tham gia nền tảng số Mặt trận và phong trào Toàn dân bảo vệ An ninh Tổ quốc',
    docType: 'Công văn',
    issuer: 'Ủy ban nhân dân thành phố Thủ Dầu Một',
    issueDate: '2026-09-02',
    effectiveDate: '2026-09-02',
    signer: 'Lê Thanh Bình',
    signerPosition: 'Phó Chủ tịch UBND Thành phố',
    field: 'Tuyên truyền - Chuyển đổi số',
    direction: 'INCOMING',
    urgency: 'VERY_URGENT',
    status: 'PROCESSING',
    effectiveStatus: 'EFFECTIVE',
    incomingNumber: 'Đ-142/2026',
    incomingDate: '2026-09-03',
    assignedDepartment: 'Tổ chức - Tuyên giáo',
    assignedStaff: 'Nguyễn Văn Hải (Phó Chủ tịch)',
    deadline: '2026-09-25',
    processingProgress: 65,
    processingNotes: 'Đã chuyển 21 Ban Công tác Mặt trận khu phố tổ chức phổ biến tại các cuộc họp chi bộ và nhóm Zalo cộng đồng. Đang tổng hợp số liệu cài đặt ứng dụng.',
    isPublic: true,
    isDigitalSigned: true,
    summary: 'UBND Thành phố đề nghị Ủy ban MTTQ Việt Nam các phường đẩy mạnh hướng dẫn đoàn viên, hội viên và nhân dân tiếp cận các tiện ích công cộng trực tuyến, bản đồ số an sinh và nắm bắt dư luận xã hội qua ứng dụng số.',
    fileName: '118_UBND_VP_Phoi_hop_tuyen_truyen_chuyen_doi_so.pdf',
    fileSize: '740 KB',
    fileType: 'application/pdf',
    tags: ['Văn bản đến', 'UBND Thành phố', 'Chuyển đổi số', 'An ninh trật tự'],
    viewCount: 180,
    downloadCount: 52
  },
  {
    id: 'doc-mttq-07',
    codeNumber: '02/CTPH-HĐND-UBND-UBMTTQ',
    title: 'Chương trình Phối hợp công tác giữa Thường trực HĐND - UBND - Ủy ban MTTQ Việt Nam phường Chánh Hiệp giai đoạn 2026 - 2030',
    docType: 'Chương trình',
    issuer: 'Liên tịch HĐND - UBND - UBMTTQ Việt Nam phường Chánh Hiệp',
    issueDate: '2026-01-22',
    effectiveDate: '2026-01-22',
    signer: 'Nguyễn Quốc Cường & Trần Thị Hoa',
    signerPosition: 'Bí thư/Chủ tịch HĐND & Chủ tịch UBMTTQ',
    field: 'Xây dựng chính quyền',
    direction: 'OUTGOING',
    urgency: 'NORMAL',
    status: 'ISSUED',
    effectiveStatus: 'EFFECTIVE',
    recipientOrg: 'Thường trực Thành ủy, Thường trực UBMTTQ Thành phố, Đảng ủy - HĐND - UBND phường',
    isPublic: true,
    isDigitalSigned: true,
    summary: 'Quy chế phối hợp liên ngành trong công tác tiếp xúc cử tri, giám sát việc giải quyết khiếu nại tố cáo của công dân, chăm lo an sinh xã hội và tổ chức các kỳ họp HĐND phường.',
    fileName: '02_CTPH_Lien_tich_HDND_UBND_MTTQ_2026_2030.pdf',
    fileSize: '2.10 MB',
    fileType: 'application/pdf',
    tags: ['Chương trình liên tịch', 'HĐND - UBND - MTTQ', 'Quy chế phối hợp'],
    viewCount: 388,
    downloadCount: 110
  },
  {
    id: 'doc-mttq-08',
    codeNumber: '31/BC-MTTQ-BTT',
    title: 'Báo cáo Sơ kết công tác Mặt trận 6 tháng đầu năm và Nhiệm vụ trọng tâm 6 tháng cuối năm 2026',
    docType: 'Báo cáo',
    issuer: 'Ủy ban MTTQ Việt Nam phường Chánh Hiệp',
    ...
    status: 'ISSUED',
    effectiveStatus: 'EFFECTIVE',
    recipientOrg: 'Thường trực UBMTTQ TP. Thủ Dầu Một, Đảng ủy phường & Các ủy viên UBMTTQ',
    isPublic: true,
    isDigitalSigned: true,
    summary: 'Đánh giá toàn diện kết quả thực hiện các phong trào thi đua yêu nước, công tác giảm nghèo, giám sát phản biện xã hội và hoạt động của 21 Ban Công tác Mặt trận trong 6 tháng đầu năm 2026.',
    fileName: '31_BC_MTTQ_So_ket_cong_tac_Mat_tran_6_thang_2026.pdf',
    fileSize: '1.85 MB',
    fileType: 'application/pdf',
    tags: ['Báo cáo 6 tháng', 'Sơ kết công tác', 'Nhiệm vụ trọng tâm'],
    viewCount: 290,
    downloadCount: 95
  },
  {
    id: 'doc-mttq-09',
    codeNumber: 'DT-04/KH-MTTQ',
    title: 'Dự thảo Kế hoạch Tổ chức Diễn đàn "Lắng nghe tiếng nói Nhân dân - Nâng cao chất lượng Đô thị văn minh Chánh Hiệp" quý IV/2026',
    docType: 'Kế hoạch',
    issuer: 'Ban Thường trực UBMTTQ Việt Nam phường Chánh Hiệp',
    issueDate: '2026-09-05',
    signer: 'Lê Văn Minh',
    signerPosition: 'Ủy viên Thường trực MTTQ',
    field: 'Dân chủ - Pháp luật',
    direction: 'INTERNAL',
    urgency: 'NORMAL',
    status: 'PENDING_APPROVAL',
    effectiveStatus: 'EFFECTIVE',
    assignedStaff: 'Lê Văn Minh',
    isPublic: false,
    summary: 'Dự thảo xin ý kiến Ban Thường vụ Đảng ủy và Ban Thường trực UBMTTQ phường trước khi ban hành chính thức. Dự kiến tổ chức tại Trung tâm Văn hóa Thể thao phường.',
    fileName: 'Du_thao_Ke_hoach_Dien_dan_Lang_nghe_tieng_noi_Nhan_dan.docx',
    fileSize: '450 KB',
    fileType: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document',
    tags: ['Dự thảo', 'Trình duyệt', 'Diễn đàn nhân dân', 'Quý IV/2026'],
    viewCount: 42,
    downloadCount: 12
  }
];
