...
export const INITIAL_ACCOUNTS: BranchAccount[] = [
  { id: 'acc_dh1', branchId: 'dh1', branchName: 'Chi đoàn Định Hòa 1', username: 'cd_dinhhoa1', passwordMasked: '••••••••', fullName: 'Trần Định Hòa Một', position: 'Bí thư Chi đoàn', phone: '0912.111.001', status: 'ACTIVE', createdAt: '01/01/2026', lastLogin: '23/09/2026 18:45' },
  { id: 'acc_dh2', branchId: 'dh2', branchName: 'Chi đoàn Định Hòa 2', username: 'cd_dinhhoa2', passwordMasked: '••••••••', fullName: 'Nguyễn Định Hòa Hai', position: 'Bí thư Chi đoàn', phone: '0912.111.002', status: 'ACTIVE', createdAt: '01/01/2026', lastLogin: '23/09/2026 18:45' },
  { id: 'acc_dh3', branchId: 'dh3', branchName: 'Chi đoàn Định Hòa 3', username: 'cd_dinhhoa3', passwordMasked: '••••••••', fullName: 'Lê Định Hòa Ba', position: 'Bí thư Chi đoàn', phone: '0912.111.003', status: 'ACTIVE', createdAt: '01/01/2026', lastLogin: '23/09/2026 18:45' },
  { id: 'acc_dh4', branchId: 'dh4', branchName: 'Chi đoàn Định Hòa 4', username: 'cd_dinhhoa4', passwordMasked: '••••••••', fullName: 'Phạm Định Hòa Bốn', position: 'Bí thư Chi đoàn', phone: '0912.111.004', status: 'ACTIVE', createdAt: '01/01/2026', lastLogin: '23/09/2026 18:45' },
  { id: 'acc_dh5', branchId: 'dh5', branchName: 'Chi đoàn Định Hòa 5', username: 'cd_dinhhoa5', passwordMasked: '••••••••', fullName: 'Hoàng Định Hòa Năm', position: 'Bí thư Chi đoàn', phone: '0912.111.005', status: 'ACTIVE', createdAt: '01/01/2026', lastLogin: '23/09/2026 18:45' },
  { id: 'acc_dh6', branchId: 'dh6', branchName: 'Chi đoàn Định Hòa 6', username: 'cd_dinhhoa6', passwordMasked: '••••••••', fullName: 'Ngô Định Hòa Sáu', position: 'Bí thư Chi đoàn', phone: '0912.111.006', status: 'ACTIVE', createdAt: '01/01/2026', lastLogin: '23/09/2026 18:45' },
  { id: 'acc_dh7', branchId: 'dh7', branchName: 'Chi đoàn Định Hòa 7', username: 'cd_dinhhoa7', passwordMasked: '••••••••', fullName: 'Vũ Định Hòa Bảy', position: 'Bí thư Chi đoàn', phone: '0912.111.007', status: 'ACTIVE', createdAt: '01/01/2026', lastLogin: '23/09/2026 18:45' },
  { id: 'acc_dh8', branchId: 'dh8', branchName: 'Chi đoàn Định Hòa 8', username: 'cd_dinhhoa8', passwordMasked: '••••••••', fullName: 'Trịnh Định Hòa Tám', position: 'Bí thư Chi đoàn', phone: '0912.111.008', status: 'ACTIVE', createdAt: '01/01/2026', lastLogin: '23/09/2026 18:45' },
  { id: 'acc_tbh1', branchId: 'tbh1', branchName: 'Chi đoàn Tương Bình Hiệp 1', username: 'cd_tuongbinhhiep1', passwordMasked: '••••••••', fullName: 'Nguyễn Bình Hiệp Một', position: 'Bí thư Chi đoàn', phone: '0913.222.001', status: 'ACTIVE', createdAt: '01/01/2026', lastLogin: '23/09/2026 18:45' },
  { id: 'acc_tbh2', branchId: 'tbh2', branchName: 'Chi đoàn Tương Bình Hiệp 2', username: 'cd_tuongbinhhiep2', passwordMasked: '••••••••', fullName: 'Lê Bình Hiệp Hai', position: 'Bí thư Chi đoàn', phone: '0913.222.002', status: 'ACTIVE', createdAt: '01/01/2026', lastLogin: '23/09/2026 18:45' },
  { id: 'acc_tbh3', branchId: 'tbh3', branchName: 'Chi đoàn Tương Bình Hiệp 3', username: 'cd_tuongbinhhiep3', passwordMasked: '••••••••', fullName: 'Trần Bình Hiệp Ba', position: 'Bí thư Chi đoàn', phone: '0913.222.003', status: 'ACTIVE', createdAt: '01/01/2026', lastLogin: '23/09/2026 18:45' },
  { id: 'acc_tbh4', branchId: 'tbh4', branchName: 'Chi đoàn Tương Bình Hiệp 4', username: 'cd_tuongbinhhiep4', passwordMasked: '••••••••', fullName: 'Phạm Bình Hiệp Bốn', position: 'Bí thư Chi đoàn', phone: '0913.222.004', status: 'ACTIVE', createdAt: '01/01/2026', lastLogin: '23/09/2026 18:45' },
  { id: 'acc_tbh5', branchId: 'tbh5', branchName: 'Chi đoàn Tương Bình Hiệp 5', username: 'cd_tuongbinhhiep5', passwordMasked: '••••••••', fullName: 'Hoàng Bình Hiệp Năm', position: 'Bí thư Chi đoàn', phone: '0913.222.005', status: 'ACTIVE', createdAt: '01/01/2026', lastLogin: '23/09/2026 18:45' },
  { id: 'acc_tbh6', branchId: 'tbh6', branchName: 'Chi đoàn Tương Bình Hiệp 6', username: 'cd_tuongbinhhiep6', passwordMasked: '••••••••', fullName: 'Ngô Bình Hiệp Sáu', position: 'Bí thư Chi đoàn', phone: '0913.222.006', status: 'ACTIVE', createdAt: '01/01/2026', lastLogin: '23/09/2026 18:45' },
  { id: 'acc_tbh7', branchId: 'tbh7', branchName: 'Chi đoàn Tương Bình Hiệp 7', username: 'cd_tuongbinhhiep7', passwordMasked: '••••••••', fullName: 'Đỗ Bình Hiệp Bảy', position: 'Bí thư Chi đoàn', phone: '0913.222.007', status: 'ACTIVE', createdAt: '01/01/2026', lastLogin: '23/09/2026 18:45' },
  { id: 'acc_ha7', branchId: 'ha7', branchName: 'Chi đoàn Hiệp An 7', username: 'cd_hiepan7', passwordMasked: '••••••••', fullName: 'Vũ Hiệp An Bảy', position: 'Bí thư Chi đoàn', phone: '0914.333.007', status: 'ACTIVE', createdAt: '01/01/2026', lastLogin: '23/09/2026 18:45' },
  { id: 'acc_ha8', branchId: 'ha8', branchName: 'Chi đoàn Hiệp An 8', username: 'cd_hiepan8', passwordMasked: '••••••••', fullName: 'Trịnh Hiệp An Tám', position: 'Bí thư Chi đoàn', phone: '0914.333.008', status: 'ACTIVE', createdAt: '01/01/2026', lastLogin: '23/09/2026 18:45' },
  { id: 'acc_ha9', branchId: 'ha9', branchName: 'Chi đoàn Hiệp An 9', username: 'cd_hiepan9', passwordMasked: '••••••••', fullName: 'Bùi Hiệp An Chín', position: 'Bí thư Chi đoàn', phone: '0914.333.009', status: 'ACTIVE', createdAt: '01/01/2026', lastLogin: '23/09/2026 18:45' },
  { id: 'acc_cm1', branchId: 'cm1', branchName: 'Chi đoàn Chánh Mỹ 1', username: 'cd_chanhmy1', passwordMasked: '••••••••', fullName: 'Phan Chánh Mỹ Một', position: 'Bí thư Chi đoàn', phone: '0915.444.001', status: 'ACTIVE', createdAt: '01/01/2026', lastLogin: '23/09/2026 18:45' },
  { id: 'acc_cm2', branchId: 'cm2', branchName: 'Chi đoàn Chánh Mỹ 2', username: 'cd_chanhmy2', passwordMasked: '••••••••', fullName: 'Võ Chánh Mỹ Hai', position: 'Bí thư Chi đoàn', phone: '0915.444.002', status: 'ACTIVE', createdAt: '01/01/2026', lastLogin: '23/09/2026 18:45' },
  { id: 'acc_myhao', branchId: 'myhao', branchName: 'Chi đoàn Mỹ Hảo', username: 'cd_myhao', passwordMasked: '••••••••', fullName: 'Đặng Mỹ Hảo', position: 'Bí thư Chi đoàn', phone: '0916.555.001', status: 'ACTIVE', createdAt: '01/01/2026', lastLogin: '23/09/2026 18:45' }
];
  ...
  try {
    ...
    if (raw) {
      ...
      if (Array.isArray(parsed) && parsed.length === 21) {
        // If cached branches contain legacy converted "Khu phố" designation names, clear cache to restore clean names
        const hasLegacyNames = parsed.some(b => b.name.includes('Khu phố 11') || b.name.includes('Định Hòa 1 (Chánh Hiệp)'));
        if (hasLegacyNames) {
...
export const loadStoredAccounts = (): BranchAccount[] => {
  try {
    ...
    if (raw) {
      ...
      if (Array.isArray(parsed) && parsed.length === 21) {
        // Reset legacy names
        const hasLegacyNames = parsed.some(a => a.branchName.includes('Khu phố 11') || a.branchName.includes('Định Hòa 1 (Chánh Hiệp)'));
        if (hasLegacyNames) {
